        ...
        <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
          <div className="flex items-center justify-between w-full md:w-auto">
            ...
            <div className="-mr-2 flex items-center md:hidden">
              <Popover.Button className="bg-slate-700 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
      ...
      >
        <div className="rounded-lg shadow-md bg-secondary ring-1 ring-black ring-opacity-5 overflow-hidden">
          <div className="px-5 pt-4 flex items-center justify-between">
            ...
            <div className="-mr-2">
              <Popover.Button  ref={buttonRef} className="bg-primary rounded-md p-2 inline-flex items-center justify-center text-seconday hover:text-seconday hover:bg-seconday focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
