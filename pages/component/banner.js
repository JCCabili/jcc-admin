    ...
    <div className="flex flex-wrap items-center justify-center px-4">
      <div className="px-4 text-center ">
        ...
        <p className="mt-3 text-base text-white sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl">
          {"I build (and sometimes design) exceptional digital experiences as a software engineer. Currently, I’m focused on building accessible, internet products at"} <a className="text-primary" href={companyUrl} target="_blank" rel="noreferrer"><b>VostroNet</b></a> 
        </p>
